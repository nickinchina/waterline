  ...
  create: function(values, cb) {
    ...
    async.series([
      ...
      if(err) return cb(err);
          ...
          console.log('create values 01',values);
...
console.log('create values 02',values);
      // Transform Values
      values = self._transformer.serialize(values);
console.log('create values 03',values);

console.log('self._schema.cleanValues',self._schema.cleanValues);

      // Clean attributes
      values = self._schema.cleanValues(values);

    console.log('create values 04',values);
